...
namespace HyperElk.Core
{
    public class SubRogueFmFlex : CombatRoutine
    {
        ...
        public override void Initialize()
        {
            ...
            CombatRoutine.AddSpell(BlackPowder);
            ...
            CombatRoutine.AddSpell(SecretTechnique, "D1");
            CombatRoutine.AddSpell(ShurikenTornado);

            CombatRoutine.AddSpell(EchoingReprimand);
            CombatRoutine.AddSpell(SerratedBoneSpike);
            CombatRoutine.AddSpell(Flagellation);
            CombatRoutine.AddSpell(Sepsis);
            ...
            CombatRoutine.AddBuff(ShurikenTornado);
            CombatRoutine.AddBuff(Stealth);
            CombatRoutine.AddBuff(Vanish);
            CombatRoutine.AddBuff(EchoingReprimand);
            CombatRoutine.AddBuff(LeadbyExample);
            CombatRoutine.AddBuff(Premeditation);
            CombatRoutine.AddBuff(TheRotten);
            CombatRoutine.AddBuff(nextCrit);
            CombatRoutine.AddBuff(Flagellation);
            ...
            CombatRoutine.AddDebuff(Flagellation);
